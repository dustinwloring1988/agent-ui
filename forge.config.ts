...
const apkName = 'AgentUI_' + packageJson.version + '_' + (process.env.arch || process.arch);
  ...
  makers: [
    ...
    ...(MakerSquirrel
      ? [
          new MakerSquirrel(
            {
              name: 'AgentUI', // 必须与 package.json 的 name 一致
              authors: 'Dustin Loring',
